function startad(){
    setTimeout(function(){
    document.getElementById('sympols').style.transform = 'scale(1)';
    document.getElementById('sympols').style.transition = 'all 0.8s';
    document.getElementById('route').style.transform = 'scale(1)';
    document.getElementById('route').style.transition = 'all 0.8s';
    },1000)
    setTimeout(function(){
    document.getElementById('icon-3-3').style.opacity = 1;
    document.getElementById('icon-3-3').style.transition = '0.8s';
    document.getElementById('tracker-2').style.transform = 'scale(1)';
    document.getElementById('tracker-2').style.transition = '0.8s';
},2000)
setTimeout(function(){
    document.getElementById('icon-3-3').style.opacity = 0;
    document.getElementById('icon-3-3').style.transition = '0.4s';
    document.getElementById('tracker-2').style.transform = 'scale(0)';
    document.getElementById('tracker-2').style.transition = '0.4s';
},2800)
...
setTimeout(function(){
    document.getElementById('sympols').style.transform = 'scale(0)';
    document.getElementById('sympols').style.transition = ' all 0.7s';
    document.getElementById('route').style.transform = 'scale(0)';
    document.getElementById('route').style.transition = ' all 0.7s';
},3700)
